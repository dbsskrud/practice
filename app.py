...
@st.cache_data
def build_geojson():
    """서울 25개 자치구 경계 polygon (근사값, 실제 행정경계 기반)"""
    # [lon_min, lat_min, lon_max, lat_max]
    bounds = {
        '강남구':   [127.022, 37.464, 127.107, 37.531],
        '강동구':   [127.103, 37.524, 127.185, 37.574],
        '강북구':   [126.988, 37.622, 127.046, 37.668],
        '강서구':   [126.793, 37.527, 126.877, 37.591],
        '관악구':   [126.900, 37.444, 126.986, 37.494],
        '광진구':   [127.055, 37.528, 127.116, 37.571],
        '구로구':   [126.832, 37.477, 126.903, 37.528],
        '금천구':   [126.876, 37.440, 126.928, 37.482],
        '노원구':   [127.050, 37.630, 127.121, 37.679],
        '도봉구':   [127.010, 37.645, 127.061, 37.695],
        '동대문구': [127.027, 37.563, 127.085, 37.611],
        '동작구':   [126.918, 37.485, 126.979, 37.531],
        '마포구':   [126.877, 37.543, 126.961, 37.586],
        '서대문구': [126.912, 37.563, 126.976, 37.608],
        '서초구':   [126.992, 37.458, 127.076, 37.511],
        '성동구':   [127.020, 37.535, 127.086, 37.575],
        '성북구':   [126.990, 37.582, 127.061, 37.638],
        '송파구':   [127.082, 37.478, 127.171, 37.533],
        '양천구':   [126.833, 37.510, 126.897, 37.555],
        '영등포구': [126.876, 37.503, 126.954, 37.546],
        '용산구':   [126.962, 37.513, 127.019, 37.557],
        '은평구':   [126.896, 37.590, 126.969, 37.648],
        '종로구':   [126.952, 37.572, 127.021, 37.636],
        '중구':     [126.968, 37.547, 127.021, 37.579],
        '중랑구':   [127.065, 37.572, 127.132, 37.626],
    }
    features = []
    for gu, (lon0, lat0, lon1, lat1) in bounds.items():
        coords = [[[lon0,lat0],[lon1,lat0],[lon1,lat1],[lon0,lat1],[lon0,lat0]]]
        features.append({
            "type": "Feature",
            "id": gu,
            "properties": {"name": gu},
